/**
 * Precompiled script plugin for publishing Anchor-DI modules to Sonatype / Maven Central.
 * Replaces the deprecated apply(from = ...) script plugin for Gradle 10 compatibility.
 *
...
val pomDescription: String =
    project.findProperty("POM_DESCRIPTION") as? String ?: "Compile-time dependency injection for Kotlin Multiplatform."
...
// Central Publisher Portal – OSSRH Staging API (token from central.sonatype.com/usertoken)

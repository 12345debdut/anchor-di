...
object ValidationPipeline {
    ...
    private val symbolPasses: List<SymbolValidationPass> = listOf(
    ...
    private val modelPasses: List<ModelValidationPass> = listOf(
    ...
    fun runModelPhase(context: ValidationModelContext, reporter: ValidationReporter) {

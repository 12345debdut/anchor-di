    ...
    fun validate(
        ...
        modules.forEach { module ->
            ...
            if (installInFqn == null) {
                ...
                reporter.error(
                    ValidationMessageFormat.formatError(
                        summary = "${module.moduleName} installs into '$componentName' ($installInFqn), which is not a known component.",
                        detail = "Known built-in components are SingletonComponent, ViewModelComponent, and NavigationComponent.",
